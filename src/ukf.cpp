...
UKF::UKF() {
  ...
  std_a_ = 4.3; //Based on wikipedia info, avg cycling speed for cyclists in Copenhagen is 9.6 mph (4.3 m/s).
    ...
    ****************************************************************************/
    if (!is_initialized_) 
	{
      ...
      */
      ...
      P_ << 0.0225,    0, 0, 0, 0,     // Square of std_laspx_
               0, 0.0225, 0, 0, 0,     // Square of std_laspy_
               0,    0, 0.09, 0, 0,    // Square of std_radr_
               0,    0, 0, 0.0009, 0,  // Square of std_radphi_
               0,    0, 0, 0, 0.09;    // Square of std_radrd_
